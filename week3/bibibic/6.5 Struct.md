...
```
7. We can use `#[derive(Debug)]` to [make a struct printable](https://doc.rust-lang.org/book/ch05-02-example-structs.html?highlight=%23[derive(Debug)]#adding-useful-functionality-with-derived-traits).
